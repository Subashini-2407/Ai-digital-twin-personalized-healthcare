...
if authenticated:
    ...
    with st.sidebar:
        ...
        # Navigation options - ADDED "AI Health Chat"
        nav_options = ["Executive Dashboard", "Risk Analysis", "Lifestyle Optimizer", 
                      ...
                      "Mobile Connection", "Twin Analysis", "AI Health Chat", "Personal Assistant", "Settings"]
        ...
        if option_menu:
            selected = option_menu(
                ...
                icons=["house", "shield", "heart", "cpu", "graph-up", 
                       ...
                       "people-fill", "chat-dots", "person-badge", "gear"],
                menu_icon="cast",
