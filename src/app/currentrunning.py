...
if authenticated:
    ...
    with st.sidebar:
        ...
        if st.button("😴 Sleep Wellness", use_container_width=True, key="nav_sleep"):
            st.session_state.selected = "Sleep Wellness"
            st.rerun()
    ...
    # ==================== AI HEALTH CHAT - CONVERSATIONAL ASSISTANT ====================
        ...
        # Input form for current question
                        ...
                        if current_question[0] == "age":
                            ...
                            try:
                                ...
                                if 1 <= stress <= 10:
                                    ...
                                    # Calculate risk after all questions
...
- Type **'new'** to start a new assessment"""
        ...
        # Handle follow-up responses after assessment
            ...
            with st.form(key="followup_form"):
                ...
                if submitted and followup_input.strip():
                    ...
                    if response_lower in ["details", "detail", "1"]:
                        ...
                        current_ex = st.session_state.chat_user_responses.get("exercise", "Moderate")
                        current_risk = st.session_state.chat_last_assessment.get('risk', 15)
                        ...
                        current_diet = st.session_state.chat_user_responses.get("diet", "Fair")
                        current_risk = st.session_state.chat_last_assessment.get('risk', 15)
                        ...
                        with col2:
                            if apt['status'] == 'confirmed':
                                if st.button(f"Join Call", key=f"join_{apt['id']}"):
                                    st.info("🎥 Connecting to video call... Meeting link: https://telemed.ai-dt.com/meet/" + hashlib.md5(f"{apt['id']}".encode()).hexdigest()[:8])
